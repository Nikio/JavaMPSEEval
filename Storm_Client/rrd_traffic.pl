#!/usr/bin/perl
#
# copyright Martin Pot 2003-2015
...
&ProcessInterface("eth1", "WLAN Eth4");
...
#	if (! -e "$rrd/$_[0].rrd")
#	{
#		print "creating rrd database for $_[0] interface at $rrd/$_[0] ...\n";
#		RRDs::create "$rrd/$_[0].rrd -s 300 DS:in:DERIVE:600:0:U DS:out:DERIVE:600:0:U 	RRA:AVERAGE:0.5:1:576 RRA:AVERAGE:0.5:6:672 RRA:AVERAGE:0.5:24:732 RRA:AVERAGE:0.5:144:1460 ";
#		print "done!\n"
#	}
...
#	  $_[2]: interface description
	...
	RRDs::graph "$_[0]-$_[1].png",
		...
		"-a", "PNG",
		"-v bytes/sec",
		"DEF:in=$_[0].rrd:in:AVERAGE",
		"DEF:out=$_[0].rrd:out:AVERAGE",
		"CDEF:out_neg=out,-1,*",
